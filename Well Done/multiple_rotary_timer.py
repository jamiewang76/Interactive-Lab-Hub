...
while True:
    ...
    draw.text((0.5*width, 0.1*height), " total", font=font, fill=(255, 255, 255))
    draw.text((0.4*width, 0.3*height), str(position2), font=font, fill=(255, 255, 255))
    draw.text((0.5*width, 0.3*height), " total", font=font, fill=(255, 255, 255))
    draw.text((0.4*width, 0.5*height), str(position3), font=font, fill=(255, 255, 255))
    draw.text((0.5*width, 0.5*height), " total", font=font, fill=(255, 255, 255))
    draw.text((0.4*width, 0.7*height), str(position4), font=font, fill=(255, 255, 255))
    draw.text((0.5*width, 0.7*height), " total", font=font, fill=(255, 255, 255))
    disp.image(image, rotation)
